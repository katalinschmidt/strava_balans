...
1. Create an API account with Strava:
    * Strava's guide found [here](https://developers.strava.com/docs/getting-started/#:~:text=If%20you%20have%20not%20already,My%20API%20Application%E2%80%9D%20page%20now)
